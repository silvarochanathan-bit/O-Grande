...
window.GymModel = {
     ...
     *
     * Para exercícios "Repetições com Peso" (rep_weight), a métrica é o VOLUME
     * total válido: soma de carga × repetições de cada série não-aquecimento e
     * marcada como feita. Séries de aquecimento nunca entram nessa soma.
     * Exemplo: 10kg×10 (aquecimento) + 15kg×10 (aquecimento) + 20kg×10 (válida)
     * + 20kg×10 (válida) → volume = (20*10) + (20*10) = 400.
     *
     * Para os demais tipos (peso do corpo, duração), onde multiplicar carga por
     * repetições não faz sentido físico, mantém-se a métrica anterior: o maior
     * valor de val1 entre as séries válidas da sessão.
     */
