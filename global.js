...
window.GlobalApp = {
    ...
    hardReset: async function() {
        ...
        const confirmed = await confirm("⚠️ ATENÇÃO: Isso apagará TODOS os dados permanentemente (Hábitos, XP, Carteira, Configurações). Não pode ser desfeito.\n\nDeseja continuar?");
        if (confirmed) {
