 ...
 * VERSÃO: SUPER APP (HUB + 3 MÓDULOS)
 */
...
window.GlobalApp = {
    ...
    loadData: function() {
        try {
            ...
            // Descomente a linha abaixo se quiser lembrar onde o usuário estava:
            // this.applyNavigation(this.data.navigation.currentApp);
            
            // Por padrão, sempre abrir no Hub ao recarregar é mais seguro/intuitivo:
            this.navigate('hub'); 
