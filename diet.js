...
window.DietManager = {
    ...
    // depth controla a indentação visual; pickable=true omite os botões de editar/excluir
    // e torna o item clicável para seleção (usado no seletor de alimento do log).
    _renderCategoryNode: function(node, container, depth, expandedState, onToggle, onPick) {
        ...
        sortedChildren.forEach(child => {
            ...
            this._renderCategoryNode(child, itemsDiv, depth + 1, expandedState, onToggle, onPick);
